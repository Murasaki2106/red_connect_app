...
class CreateAccountPage2 extends StatefulWidget {
  ...
  @override
  State<CreateAccountPage2> createState() => _CreateAccountPage1State();
}

class _CreateAccountPage1State extends State<CreateAccountPage2> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Fields
            buildTextField("Contact No.", _firstName),
            const SizedBox(height: 16),

            buildTextField("Residence", _middleName),
            const SizedBox(height: 16),

            buildTextField("Area", _lastName),
            const SizedBox(height: 16),

            buildTextField("City", _age, keyboardType: TextInputType.number),
            const SizedBox(height: 16),

            buildTextField("State", _gender),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const CreateAccountPage3()),
                    );
                  },
